...
from Launchkey.SpecialMixerComponent import SpecialMixerComponent
from Launchkey.consts import *
...
#        return make_configurable_button(120, 'Scene_Stop_Button')
    ...
    def create_device_switch_button(self):
        return make_configurable_button(104, 'Device_Switch_Button')

    def create_device_next_button(self):
        return make_configurable_button(120, 'Device_Next_Button')

#    def create_device_prev_button(self):
#        return make_configurable_button(-1, 'Device_Prev_Button')
...
#        device_next_button = self._control_factory.create_device_next_button()
...
#        scene_stop_button.set_on_off_values(AMBER_FULL, LED_OFF)
    ...
    def _setup_navigation(self):
        ...
        self._device_next_button = self._control_factory.create_device_next_button()
        self._device_next_button.add_value_listener(self._next_device_value, identify_sender=False)
